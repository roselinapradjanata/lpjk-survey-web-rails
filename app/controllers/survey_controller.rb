class SurveyController < ApplicationController
	...
	def index
		...
		technology_construction_assessment_methods = TechnologyConstructionAssessmentMethodService.get_all
		...
		return render json: {
			...
			technology_construction_assessment_methods: technology_construction_assessment_methods,
